...
export class WaterService {
  ...
  private path = '/dwm/water';
  private currentRec$ = new BehaviorSubject<WaterModel>(null);
  private currentForm$: BehaviorSubject<FormGroup | undefined> =
        new BehaviorSubject(this.formBuilder.group(new WaterModel()));
  ...
  public saveReport(report: WaterModel) {
