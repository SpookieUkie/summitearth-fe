...
@Component({
  selector: 'app-dfr-rrr-attachments',
  templateUrl: './dfr-rrr-attachments.component.html',
  styleUrls: ['./dfr-rrr-attachments.component.scss'],
})
export class DfrRrrAttachmentsComponent implements OnInit {
