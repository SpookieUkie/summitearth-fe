...
@Component({
  selector: 'app-fieldoptionpicker',
  templateUrl: './fieldoptionpicker.component.html',
  styleUrls: ['./fieldoptionpicker.component.scss'],
})
export class FieldoptionpickerComponent implements OnInit {

  @ViewChild('ionSearchBox') ionSearchBox: IonSearchbar;
